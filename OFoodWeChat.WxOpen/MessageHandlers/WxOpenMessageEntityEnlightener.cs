...
namespace OFoodWeChat.WxOpen.MessageHandlers
{
   public class WxOpenMessageEntityEnlightener : MessageEntityEnlightener
    {
        public static MessageEntityEnlightener Instance = new WxOpenMessageEntityEnlightener(PlatformType.WeChat_MiniProgram);


        WxOpenMessageEntityEnlightener(PlatformType platformType) : base(platformType) { }
        ...
        {
            return new OFoodWeChat.MP.Entities.ResponseMessageText();
