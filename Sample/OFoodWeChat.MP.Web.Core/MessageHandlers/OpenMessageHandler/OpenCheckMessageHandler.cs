...
using OFoodWeChat.MP.Web.Core.CustomMessageHandler;
using OFoodWeChat.MP.Web.Core.OpenTicket;
...
namespace OFoodWeChat.MP.Web.Core.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
        ...
        */
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            if (requestMessage.Content.StartsWith("QUERY_AUTH_CODE:"))
            {
                ...
                try
                {
                    var component_access_token = OFoodWeChat.Open.ComponentAPIs.ComponentApi.GetComponentAccessToken(componentAppId, componentSecret, openTicket).component_access_token;
