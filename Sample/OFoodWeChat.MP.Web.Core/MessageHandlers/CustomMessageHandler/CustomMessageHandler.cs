...
using OFoodWeChat.Infrastructure.Entities.Request;
using OFoodWeChat.Infrastructure.Agents;
...
namespace OFoodWeChat.MP.Web.Core.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        private string appId = WxConfig.WeixinSetting.WeixinAppId;
        private string appSecret = WxConfig.WeixinSetting.WeixinAppSecret;
