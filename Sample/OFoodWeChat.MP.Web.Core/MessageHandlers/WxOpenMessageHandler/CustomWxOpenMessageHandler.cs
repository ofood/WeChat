...
using OFoodWeChat.WxOpen;
using OFoodWeChat.WxOpen.MessageHandlers;
...
namespace OFoodWeChat.MP.Web.Core.WxOpenMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    ...
    {
        private string appId = WxConfig.WeixinSetting.WxOpenAppId;
        private string appSecret = WxConfig.WeixinSetting.WxOpenAppSecret;
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            {
                //发送客服消息
                OFoodWeChat.WxOpen.AdvancedAPIs.CustomApi.SendLink(appId, OpenId, "欢迎使用 Senparc.Weixin SDK", "感谢大家的支持！\r\n\r\n盛派永远在你身边！",
            ...
            else if (contentUpper == "CARD")
            {
                ...
                //发送客服消息
                OFoodWeChat.WxOpen.AdvancedAPIs.CustomApi.SendMiniProgramPage(appId, OpenId, "欢迎使用 Senparc.Weixin SDK", "pages/websocket/websocket",
            ...
            else
            {
                ...
                //发送客服消息
                OFoodWeChat.WxOpen.AdvancedAPIs.CustomApi.SendText(appId, OpenId, msg);
        ...
        public override IResponseMessageBase OnImageRequest(RequestMessageImage requestMessage)
        {
            ...
            {
                await OFoodWeChat.WxOpen.AdvancedAPIs.CustomApi.SendTextAsync(appId, OpenId, "刚才您发送了这张图片：");
                await OFoodWeChat.WxOpen.AdvancedAPIs.CustomApi.SendImageAsync(appId, OpenId, requestMessage.MediaId);
            });
