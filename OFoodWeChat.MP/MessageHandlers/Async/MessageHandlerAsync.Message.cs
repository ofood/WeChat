...
namespace OFoodWeChat.MP.MessageHandlers
{
    public abstract partial class MessageHandler<TC>
    {
        ...
        {
            var result = base.DefaultMessageHandlerAsyncEvent == DefaultMessageHandlerAsyncEvent.DefaultResponseMessageAsync
                   ? null
        ...
        {
            return await DefaultAsyncMethod(requestMessage, () => OnNeuCharRequestAsync(requestMessage).Result);
        }
