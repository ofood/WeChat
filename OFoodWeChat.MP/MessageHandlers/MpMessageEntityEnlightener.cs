...
namespace OFoodWeChat.MP.MessageHandlers
{
    ...
    public class MpMessageEntityEnlightener : MessageEntityEnlightener
    {
        ...
        /// </summary>
        public static MessageEntityEnlightener Instance = new MpMessageEntityEnlightener(PlatformType.WeChat_OfficialAccount);

        MpMessageEntityEnlightener(PlatformType platformType) : base(platformType) { }
