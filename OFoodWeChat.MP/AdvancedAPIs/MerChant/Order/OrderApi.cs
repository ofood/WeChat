...
namespace OFoodWeChat.MP.AdvancedAPIs.MerChant
{
    ...
    public static class OrderApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.GetByIdOrder", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.GetByFilterOrder", true)]
        ...
        /// 汇通快运	020huitong
        /// 易迅快递	zj001yixun
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.SetdeliveryOrder", true)]
        ...
        /// <param name="orderId">订单ID</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.CloseOrder", true)]
        ...
        /// <param name="orderId">订单Id</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.GetByIdOrderAsync", true)]
        public static async Task<GetByIdOrderResult> GetByIdOrderAsync(string accessToken, string orderId)
        {
            ...
            return await CommonJsonSend.SendAsync<GetByIdOrderResult>(accessToken, urlFormat, data);
        }
        ...
        /// <param name="endTime">订单创建时间终止时间(不带该字段则不按照时间做筛选)</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.GetByFilterOrderAsync", true)]
        public static async Task<GetByFilterResult> GetByFilterOrderAsync(string accessToken, int? status, DateTime? beginTime, DateTime? endTime)
        {
            ...
            return await CommonJsonSend.SendAsync<GetByFilterResult>(accessToken, urlFormat, data, jsonSetting: new JsonSetting(true));
        }
        ...
        /// 汇通快运	020huitong
        /// 易迅快递	zj001yixun
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.SetdeliveryOrderAsync", true)]
        ...
        /// <param name="orderId">订单ID</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OrderApi.CloseOrderAsync", true)]
