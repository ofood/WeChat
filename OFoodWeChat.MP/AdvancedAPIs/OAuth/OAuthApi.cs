...
namespace OFoodWeChat.MP.AdvancedAPIs
{
    public static class OAuthApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.GetAuthorizeUrl", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.GetAccessToken", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.RefreshToken", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.GetUserInfo", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.Auth", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.GetAccessTokenAsync", true)]
        ...
        /// <param name="grantType"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.RefreshTokenAsync", true)]
        ...
        /// <param name="lang">返回国家地区语言版本，zh_CN 简体，zh_TW 繁体，en 英语</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.GetUserInfoAsync", true)]
        ...
        /// <param name="openId">用户的唯一标识</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "OAuthApi.AuthAsync", true)]
