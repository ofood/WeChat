...
namespace OFoodWeChat.MP.CommonAPIs
{
    public partial class CommonApi
    {
        ...
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetButtonGroup", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetMenuFromJsonResult", true)]
