...
namespace OFoodWeChat.MP.CommonAPIs
{
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.CreateMenu", true)]
        ...
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetSingleButtonFromJsonObject", true)]
        ...
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetMenuFromJson", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetMenu", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.DeleteMenu", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetCurrentSelfMenuInfo", true)]
        public static SelfMenuConfigResult GetCurrentSelfMenuInfo(string accessTokenOrAppId, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/get_current_selfmenu_info?access_token={0}", accessToken.AsUrlData());
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetCurrentSelfMenuInfo", true)]
        public static async Task<SelfMenuConfigResult> GetCurrentSelfMenuInfoAsync(string accessTokenOrAppId, int timeOut = WxConfig.TIME_OUT)
        {
