...
namespace OFoodWeChat.MP.CommonAPIs
{
    ...
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetToken", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetUserInfo", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetTicket", true)]
        ...
        /// <param name="type">默认为jsapi，当作为卡券接口使用时，应当为wx_card</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetTicketByAccessToken", true)]
        ...
        /// <param name="accessTokenOrAppId">AccessToken或AppId（推荐使用AppId，需要先注册）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetCallBackIp", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CardApi.Clear_quota", true)]
        public static WxJsonResult Clear_quota(string accessTokenOrAppId, string appId, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format(WxConfig.ApiMpHost + "/cgi-bin/clear_quota?access_token={0}", accessToken.AsUrlData());
                var data = new
                {
                    appid = appId
                };
        ...
        /// <param name="secret">第三方用户唯一凭证密钥，既appsecret</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetTokenAsync", true)]
        ...
        /// <param name="openId"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetUserInfoAsync", true)]
        ...
        /// <param name="type">默认为jsapi，当作为卡券接口使用时，应当为wx_card</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetTicketAsync", true)]
        ...
        /// <param name="type">默认为jsapi，当作为卡券接口使用时，应当为wx_card</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetTicketByAccessTokenAsync", true)]
        ...
        /// <param name="accessTokenOrAppId">AccessToken或AppId（推荐使用AppId，需要先注册）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CommonApi.GetCallBackIpAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_OfficialAccount, "CardApi.Clear_quotaAsync", true)]
        public static async Task<WxJsonResult> Clear_quotaAsync(string accessTokenOrAppId, string appId, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var urlFormat = string.Format(WxConfig.ApiMpHost + "/cgi-bin/clear_quota?access_token={0}", accessToken.AsUrlData());
