    ...
    public static partial class TenPayV3
    {
        ...
        private static string CertPost(string cert, string certPassword, string data, string url, int timeOut = WxConfig.TIME_OUT)
        {
            ...
            using (MemoryStream ms = new MemoryStream(dataBytes))
            {
                ...
                //    cer: cer,
                //    timeOut: timeOut);
                string responseContent = RequestUtility.HttpPost(url, new CookieContainer(), postStream: ms, timeOut: timeOut);
        ...
        {
            return string.Format(urlFormat, WxConfig.UseSandBoxPay ? "sandboxnew/" : "");
        }
        ...
        /// <returns></returns>
        [Obsolete("此方法已过期，建议使用 Unifiedorder(TenPayV3XmlDataInfo dataInfo, int timeOut = WxConfig.TIME_OUT)")]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [Obsolete("此方法已过期，建议使用 Transfers(TenPayV3TransfersRequestData dataInfo, int timeOut = WxConfig.TIME_OUT)")]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static TransfersResult PayToWorker(TenPayV3PayToWorkerRequestData dataInfo, string cert, string certPassword, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [Obsolete("此方法已过期，建议使用 GetTransferInfo(TenPayV3GetTransferInfoRequestData dataInfo, int timeOut = WxConfig.TIME_OUT)")]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetTransferInfoResult QueryPayLog(TenPayV3GetTransferInfoRequestData dataInfo, string cert, string certPassword, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [Obsolete("此方法已过期，建议使用  TransfersAsync(TenPayV3TransfersRequestData dataInfo, int timeOut = WxConfig.TIME_OUT)")]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [Obsolete("此方法已过期，建议使用GetTransferInfoAsync(TenPayV3GetTransferInfoRequestData dataInfo, int timeOut = WxConfig.TIME_OUT)")]
