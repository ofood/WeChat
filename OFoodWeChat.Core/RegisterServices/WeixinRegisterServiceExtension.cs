...
namespace OFoodWeChat.Core.RegisterServices
{
    /// <summary>
    ...
    public static class RegisterServiceExtension
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddWeixinServices(this IServiceCollection serviceCollection, IConfiguration configuration)
        {
            serviceCollection.Configure<WeixinSetting>(configuration.GetSection("WeixinSetting"));
