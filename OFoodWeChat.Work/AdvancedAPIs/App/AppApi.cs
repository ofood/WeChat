...
using OFoodWeChat.Work.AdvancedAPIs.App;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    ...
    public static class AppApi
    {
        ...
        /// <summary>
        /// 获取企业号应用信息【QY移植修改】WxConfig.ApiWorkHost
        /// </summary>
        /// <param name="accessTokenOrAppKey">调用接口凭证（AccessToken）或AppKey（根据AccessTokenContainer.BuildingKey(corpId, corpSecret)方法获得）</param>
        /// <param name="agentId">企业应用的id，可在应用的设置页面查看</param>
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.GetAppInfo", true)]
        public static GetAppInfoResult GetAppInfo(string accessTokenOrAppKey, int agentId, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string url = string.Format(WxConfig.ApiWorkHost + "/cgi-bin/agent/get?access_token={0}&agentid={1}", accessToken.AsUrlData(), agentId.ToString("d").AsUrlData());
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.SetApp", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.GetAppList", true)]
        public static GetAppListResult GetAppList(string accessTokenOrAppKey, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                string url = WxConfig.ApiWorkHost + "/cgi-bin/agent/list?access_token={0}";
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.GetAppInfoAsync", true)]
        public static async Task<GetAppInfoResult> GetAppInfoAsync(string accessTokenOrAppKey, int agentId, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.SetAppAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AppApi.GetAppListAsync", true)]
        public static async Task<GetAppListResult> GetAppListAsync(string accessTokenOrAppKey, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                string url = WxConfig.ApiWorkHost + "/cgi-bin/agent/list?access_token={0}";
