...
using OFoodWeChat.Work.AdvancedAPIs.OAuth2;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    ...
    public static class OAuth2Api
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "OAuth2Api.GetCode", true)]
        ...
        [ApiBind(PlatformType.WeChat_Work, "OAuth2Api.GetUserId", true)]
        public static GetUserInfoResult GetUserId(string accessToken, string code, string agentId)
        {
            var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/user/getuserinfo?access_token={0}&code={1}&agentid={2}", accessToken.AsUrlData(), code.AsUrlData(), agentId.AsUrlData());
        ...
        {
            var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/user/getuserinfo?access_token={0}&code={1}", accessToken.AsUrlData(), code.AsUrlData());
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "OAuth2Api.GetUserDetail", true)]
        public static GetUserDetailResult GetUserDetail(string accessToken, string userTicket)
        {
            var urlFormat = WxConfig.ApiMpHost + "/cgi-bin/user/getuserdetail?access_token={0}";
        ...
        /// <returns></returns>
        [Obsolete("请使用新方法GetUserId(string accessToken, string code)")]
        [ApiBind(PlatformType.WeChat_Work, "OAuth2Api.GetUserIdAsync", true)]
        ...
        /// <param name="userTicket">成员票据</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "OAuth2Api.GetUserDetailAsync", true)]
