...
using OFoodWeChat.Work.AdvancedAPIs.LoginAuth;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    public static class LoginAuthApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "LoginAuthApi.GetLoginUrl", true)]
        public static GetLoginUrlResult GetLoginUrl(string providerAccessToken, string loginTicket, string target, int agentid, int timeOut = WxConfig.TIME_OUT)
        {
                string url = WxConfig.ApiMpHost + "/cgi-bin/service/get_login_url?provider_access_token={0}";
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "LoginAuthApi.GetLoginUrlAsync", true)]
        public static async Task<GetLoginUrlResult> GetLoginUrlAsync(string providerAccessToken, string loginTicket, string target, int agentid, int timeOut = WxConfig.TIME_OUT)
        {
                string url = WxConfig.ApiMpHost + "/cgi-bin/service/get_login_url?provider_access_token={0}";
                ...
                return await CommonJsonSend.SendAsync<GetLoginUrlResult>(providerAccessToken, url, data, CommonJsonSendType.POST, timeOut);
