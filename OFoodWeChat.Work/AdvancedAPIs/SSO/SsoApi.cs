/*----------------------------------------------------------------
    ...
    修改描述：修改命名空间为 OFoodWeChat.Work.AdvancedAPIs

    ----------------------------------------------------------------*/
using OFoodWeChat.Work.AdvancedAPIs.SSO;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    ...
    public class SsoApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "SsoApi.GetLoginAuthUrl", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "SsoApi.GetProviderToken", true)]
        public static ProviderTokenResult GetProviderToken(string corpId, string providerSecret, int timeOut = WxConfig.TIME_OUT)
        {
                var url = WxConfig.ApiMpHost + "/cgi-bin/service/get_provider_token";
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "SsoApi.GetLoginInfo", true)]
        public static GetLoginInfoResult GetLoginInfo(string providerAccessToken, string authCode, int timeOut = WxConfig.TIME_OUT)
        {
                string url = WxConfig.ApiMpHost + "/cgi-bin/service/get_login_info?provider_access_token={0}";
                ...
                return CommonJsonSend.Send<GetLoginInfoResult>(providerAccessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "SsoApi.GetLoginInfoAsync", true)]
        public static async Task<GetLoginInfoResult> GetLoginInfoAsync(string providerAccessToken, string authCode, int timeOut = WxConfig.TIME_OUT)
        {
                string url = WxConfig.ApiMpHost + "/cgi-bin/service/get_login_info?provider_access_token={0}";
                ...
                return await CommonJsonSend.SendAsync<GetLoginInfoResult>(providerAccessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "SsoApi.GetProviderTokenAsync", true)]
        public static async Task<ProviderTokenResult> GetProviderTokenAsync(string corpId, string providerSecret, int timeOut = WxConfig.TIME_OUT)
        {
                var url = WxConfig.ApiMpHost + "/cgi-bin/service/get_provider_token";
                ...
                return await CommonJsonSend.SendAsync<ProviderTokenResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
