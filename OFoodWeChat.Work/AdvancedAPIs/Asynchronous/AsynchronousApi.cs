...
using OFoodWeChat.Work.AdvancedAPIs.Asynchronous;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    ...
    public static class AsynchronousApi
    {
        ...
        */
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchSyncUser", true)]
        public static AsynchronousJobId BatchSyncUser(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = WxConfig.ApiWorkHost + "/cgi-bin/batch/syncuser?access_token={0}";
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceUser", true)]
        public static AsynchronousJobId BatchReplaceUser(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = WxConfig.ApiWorkHost + "/cgi-bin/batch/replaceuser?access_token={0}";
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceParty", true)]
        public static AsynchronousJobId BatchReplaceParty(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = WxConfig.ApiWorkHost + "/cgi-bin/batch/replaceparty?access_token={0}";
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.GetReplaceUserResult", true)]
        public static AsynchronousReplaceUserResult GetReplaceUserResult(string accessTokenOrAppKey, string jobId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(WxConfig.ApiWorkHost + "/cgi-bin/batch/getresult?access_token={0}&jobid={1}",
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.GetReplacePartyResult", true)]
        ...
        */
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchSyncUserAsync", true)]
        public static async Task<AsynchronousJobId> BatchSyncUserAsync(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchReplaceUserAsync", true)]
        public static async Task<AsynchronousJobId> BatchReplaceUserAsync(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = WxConfig.ApiWorkHost + "/cgi-bin/batch/replaceuser?access_token={0}";
        ...
        /// }
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.BatchReplacePartyAsync", true)]
        public static async Task<AsynchronousJobId> BatchReplacePartyAsync(string accessTokenOrAppKey, string mediaId, Asynchronous_CallBack callBack, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = WxConfig.ApiWorkHost + "/cgi-bin/batch/replaceparty?access_token={0}";
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.GetReplaceUserResultAsync", true)]
        ...
        /// <param name="jobId"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "AsynchronousApi.GetReplacePartyResultAsync", true)]
