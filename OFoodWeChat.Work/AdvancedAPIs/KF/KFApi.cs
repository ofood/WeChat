...
using OFoodWeChat.Work.AdvancedAPIs.KF;
...
namespace OFoodWeChat.Work.AdvancedAPIs
{
    ...
    {
        private static string _urlFormat = WxConfig.ApiMpHost + "/cgi-bin/kf/send?access_token={0}";
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendText", true)]
        public static WorkJsonResult SendText(string accessTokenOrAppKey, KF_User_Type senderType, string senderId, KF_User_Type receiverType,
            string receiverId, string content, int timeOut = WxConfig.TIME_OUT)
        {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendImage", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendFile", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendVoice", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.GetKFList", true)]
        public static GetKFListResult GetKFList(string accessTokenOrAppKey, KF_Type? type = null, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/kf/list?access_token={0}&type={1}", accessToken, type);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendTextAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendImageAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendFileAsync", true)]
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.SendVoiceAsync", true)]
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "KFApi.GetKFListAsync", true)]
        public static async Task<GetKFListResult> GetKFListAsync(string accessTokenOrAppKey, KF_Type? type = null, int timeOut = WxConfig.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(async accessToken =>
            {
                var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/kf/list?access_token={0}&type={1}", accessToken, type);

                return await CommonJsonSend.SendAsync<GetKFListResult>(null, url, null, CommonJsonSendType.GET, timeOut);
            }, accessTokenOrAppKey);
