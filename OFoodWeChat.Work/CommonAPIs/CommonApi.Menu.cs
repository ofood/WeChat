...
namespace OFoodWeChat.Work.CommonAPIs
{
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.CreateMenu", true)]
        public static WorkJsonResult CreateMenu(string accessTokenOrAppId, int agentId, ButtonGroup buttonData, int timeOut = WxConfig.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                var urlFormat = string.Format(WxConfig.ApiMpHost + "/cgi-bin/menu/create?access_token={0}&agentid={1}", accessToken.AsUrlData(), agentId);
        ...
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.GetSingleButtonFromJsonObject", true)]
        ...
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.GetMenuFromJson", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.GetMenu", true)]
        public static GetMenuResult GetMenu(string accessTokenOrAppId, int agentId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {

                var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/menu/get?access_token={0}&agentid={1}", accessToken.AsUrlData(), agentId);
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.GetMenuFromJsonResult", true)]
        ...
        /// <param name="agentId">企业应用的id，整型。可在应用的设置页面查看</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.DeleteMenu", true)]
        public static WorkJsonResult DeleteMenu(string accessTokenOrAppId, int agentId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format(WxConfig.ApiMpHost + "/cgi-bin/menu/delete?access_token={0}&agentid={1}", accessToken.AsUrlData(), agentId);
        ...
        /// <param name="agentId">企业应用的id，整型。可在应用的设置页面查看</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Work, "CommonApi.DeleteMenuAsync", true)]
