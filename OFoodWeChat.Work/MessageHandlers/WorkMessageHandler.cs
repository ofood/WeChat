...
using OFoodWeChat.Work.Helpers;
using OFoodWeChat.Work.Tencent;
using OFoodWeChat.Work.AdvancedAPIs;
...
namespace OFoodWeChat.Work.MessageHandlers
{
        ...
        where TC : class, IMessageContext<IWorkRequestMessageBase, IWorkResponseMessageBase>, new()
    {
        ...
        /// 这里是OFoodWeChat.Work，应当在ResponseDocument基础上进行加密（每次获取重新加密，所以结果会不同）
        /// </summary>
