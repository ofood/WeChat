...
namespace OFoodWeChat.Work.MessageHandlers
{
    public class WorkMessageEntityEnlightener : MessageEntityEnlightener
    {
        public static MessageEntityEnlightener Instance = new WorkMessageEntityEnlightener(PlatformType.WeChat_Work);

        WorkMessageEntityEnlightener(PlatformType platformType) : base(platformType) { }
