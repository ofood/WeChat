...
using OFoodWeChat.Open.WxaAPIs.NickName.CheckWxVerifyNickNameJson;
using OFoodWeChat.Open.WxaAPIs.NickName.QueryNickNameJson;
using OFoodWeChat.Open.WxaAPIs.NickName.SetNickNameJson;

namespace OFoodWeChat.Open.WxaAPIs.NickName
{
    /// <summary>
    /// 小程序昵称设置
    ...
    public class NickNameApi
    {
        ...
        {
            var url = $"{WxConfig.ApiMpHost}/wxa/setnickname?access_token={accessToken.AsUrlData()}";
        ...
        {
            var url = $"{WxConfig.ApiMpHost}/wxa/api_wxa_querynickname?access_token={accessToken.AsUrlData()}";
        ...
        {
            var url =
                $"{WxConfig.ApiMpHost}/cgi-bin/wxverify/checkwxverifynickname?access_token={accessToken.AsUrlData()}";
            var data = new
            {
                nick_name = nick_name
            };
