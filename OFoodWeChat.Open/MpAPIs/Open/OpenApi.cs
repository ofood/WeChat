...
namespace OFoodWeChat.Open.MpAPIs.Open
{
    public static class OpenApi
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.Create", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.Bind", true)]
        public static OpenJsonResult Bind(string accessToken, string appId, string openAppid)
        {
            var urlFormat = WxConfig.ApiMpHost + "/cgi-bin/open/bind?access_token={0}";
            var data = new { appid = appId, open_appid = openAppid };
            return CommonJsonSend.Send<OpenJsonResult>(accessToken, urlFormat, data);
        }
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.Unbind", true)]
        public static OpenJsonResult Unbind(string accessToken, string appId, string openAppid)
        {
            var urlFormat = WxConfig.ApiMpHost + "/cgi-bin/open/unbind?access_token={0}";
            var data = new { appid = appId, open_appid = openAppid };
            return CommonJsonSend.Send<OpenJsonResult>(accessToken, urlFormat, data);
        }
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.Get", true)]
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.CreateAsync", true)]
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.BindAsync", true)]
        public static async Task<OpenJsonResult> BindAsync(string accessToken, string appId, string openAppid)
        {
            var urlFormat = WxConfig.ApiMpHost + "/cgi-bin/open/bind?access_token={0}";
            var data = new { appid = appId, open_appid = openAppid };
            return await CommonJsonSend.SendAsync<OpenJsonResult>(accessToken, urlFormat, data);
        }
        ...
        /// <param name="openAppid">开放平台帐号appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.UnbindAsync", true)]
        public static async Task<OpenJsonResult> UnbindAsync(string accessToken, string appId, string openAppid)
        {
            var urlFormat = WxConfig.ApiMpHost + "/cgi-bin/open/unbind?access_token={0}";
            var data = new { appid = appId, open_appid = openAppid };
            return await CommonJsonSend.SendAsync<OpenJsonResult>(accessToken, urlFormat, data);
        ...
        /// <param name="appId">授权公众号或小程序的appid</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OpenApi.GetAsync", true)]
