...
namespace OFoodWeChat.Open.OAuthAPIs
{
    ...
    public static class OAuthApi
    {
       ...
       /*此接口不提供异步方法*/
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.GetAuthorizeUrl", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.GetAccessToken", true)]
        ...
        {
            var url =
                string.Format(WxConfig.ApiMpHost + "/sns/oauth2/component/access_token?appid={0}&code={1}&grant_type={2}&component_appid={3}&component_access_token={4}",
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.RefreshToken", true)]
        ...
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/oauth2/component/refresh_token?appid={0}&grant_type={1}&component_appid={2}&component_access_token={3}&refresh_token={4}",
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.GetUserInfo", true)]
        public static OAuthUserInfo GetUserInfo(string accessToken, string openId, Language lang = Language.zh_CN)
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/userinfo?access_token={0}&openid={1}&lang={2}", accessToken.AsUrlData(), openId.AsUrlData(), lang);
            /*
        ...
        /// <param name="grantType"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.GetAccessTokenAsync", true)]
        ...
        /// <param name="componentAppid"></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.RefreshTokenAsync", true)]
        ...
        /// <param name="lang">返回国家地区语言版本，zh_CN 简体，zh_TW 繁体，en 英语</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "OAuthApi.GetUserInfoAsync", true)]
