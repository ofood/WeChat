...
using OFoodWeChat.Open.AccountAPIs.AccountBasicInfoJson;
using OFoodWeChat.Open.AccountAPIs.FastRegisterJson;
using OFoodWeChat.Open.MpAPIs.Open;
...
namespace OFoodWeChat.Open.AccountAPIs
{
    /// <summary>
    /// 小程序信息设置
    ...
    public class AccountApi
    {
        ...
        /// </param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.FastRegisterAuth", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.FastRegister", true)]
        public static FastRegisterJsonResult FastRegister(string accessToken, string ticket)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/fastregister?access_token={accessToken.AsUrlData()}";
        ...
        /// </param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.GetAccountBasicInfo", true)]
        public static AccountBasicInfoJsonResult GetAccountBasicInfo(string accessToken)
        {
            var url =
                $"{WxConfig.ApiMpHost}/cgi-bin/account/getaccountbasicinfo?access_token={accessToken.AsUrlData()}";
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ModifyHeadImage", true)]
        public static OpenJsonResult ModifyHeadImage(string accessToken, string head_img_media_id, float x1, float y1,
            float x2, float y2)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/modifyheadimage?access_token={accessToken.AsUrlData()}";
            var data = new
            {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ModifySignature", true)]
        public static OpenJsonResult ModifySignature(string accessToken, string signature)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/modifysignature?access_token={accessToken.AsUrlData()}";
            var data = new
            {
                signature = signature
            };
        ...
        /// <para><see cref="OFoodWeChat.Open.WxOpenAPIs.WxOpenApi.ComponentRebindAdmin"/></para></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ComponentRebindAdmin", true)]
        public static OpenJsonResult ComponentRebindAdmin(string accessToken, string taskid)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/componentrebindadmin?access_token={accessToken.AsUrlData()}";
        ...
        /// <param name="ticket">公众号扫码授权的凭证(公众平台扫码页面回跳到第三方平台时携带)</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.FastRegisterAsync", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.GetAccountBasicInfoAsync", true)]
        ...
        /// <param name="y2">裁剪框右下角y坐标（取值范围：[0, 1]）</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ModifyHeadImageAsync", true)]
        public static async Task<OpenJsonResult> ModifyHeadImageAsync(string accessToken, string head_img_media_id, float x1, float y1,
            float x2, float y2)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/modifyheadimage?access_token={accessToken.AsUrlData()}";
            var data = new
        ...
        /// <param name="signature">功能介绍</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ModifySignatureAsync", true)]
        public static async Task<OpenJsonResult> ModifySignatureAsync(string accessToken, string signature)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/modifysignature?access_token={accessToken.AsUrlData()}";
            var data = new
            {
        ...
        /// <para><see cref="OFoodWeChat.Open.WxOpenAPIs.WxOpenApi.ComponentRebindAdmin"/></para></param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "AccountApi.ComponentRebindAdminAsync", true)]
        public static async Task<OpenJsonResult> ComponentRebindAdminAsync(string accessToken, string taskid)
        {
            var url = $"{WxConfig.ApiMpHost}/cgi-bin/account/componentrebindadmin?access_token={accessToken.AsUrlData()}";
            var data = new { taskid = taskid };
            return await CommonJsonSend.SendAsync<OpenJsonResult>(null, url, data);
