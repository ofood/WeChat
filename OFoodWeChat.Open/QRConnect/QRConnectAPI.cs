...
namespace OFoodWeChat.Open.QRConnect
{
    /// <summary>
    /// 代公众号发起网页授权
    /// </summary>
    public static class QRConnectAPI
    {
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.GetQRConnectUrl", true)]
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.GetAccessToken", true)]
        public static QRConnectAccessTokenResult GetAccessToken(string appId, string appSecret, string code, string grantType = "authorization_code")
        {
            var url =
                string.Format(
                    WxConfig.ApiMpHost + "/sns/oauth2/access_token?appid={0}&secret={1}&code={2}&grant_type={3}",
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.RefreshToken", true)]
        public static RefreshAccessTokenResult RefreshToken(string appId, string refreshToken, string grantType = "refresh_token")
        {
            var url =
                string.Format(
                    WxConfig.ApiMpHost + "/sns/oauth2/refresh_token?appid={0}&grant_type={1}&refresh_token={2}",
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.GetUserInfo", true)]
        public static QRConnectUserInfo GetUserInfo(string accessToken, string openId)
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/userinfo?access_token={0}&openid={1}", accessToken.AsUrlData(), openId.AsUrlData());
            /*
        ...
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.Auth", true)]
        public static OpenJsonResult Auth(string accessToken, string openId)
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/auth?access_token={0}&openid={1}", accessToken.AsUrlData(), openId.AsUrlData());
            return CommonJsonSend.Send<OpenJsonResult>(null, url, null, CommonJsonSendType.GET);
        }
        #endregion
        ...
        /// <param name="grantType">填authorization_code</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.GetAccessTokenAsync", true)]
        public static async Task<QRConnectAccessTokenResult> GetAccessTokenAsync(string appId, string appSecret, string code, string grantType = "authorization_code")
        {
            ...
            出错返回：{"errcode":40029,"errmsg":"invalid code"}
            */
            return await CommonJsonSend.SendAsync<QRConnectAccessTokenResult>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        /// <param name="grantType">填refresh_token</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.RefreshTokenAsync", true)]
        public static async Task<RefreshAccessTokenResult> RefreshTokenAsync(string appId, string refreshToken, string grantType = "refresh_token")
        {
            ...
            return await CommonJsonSend.SendAsync<RefreshAccessTokenResult>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        /// <param name="openId">普通用户的标识，对当前公众号唯一</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.GetUserInfoAsync", true)]
        public static async Task<QRConnectUserInfo> GetUserInfoAsync(string accessToken, string openId)
        {
            ...
            /*
             ...
             错误时微信会返回JSON数据包如下（示例为openid无效）:{"errcode":40003,"errmsg":" invalid openid "}
             */
            return await CommonJsonSend.SendAsync<QRConnectUserInfo>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        /// <param name="openId">用户的唯一标识</param>
        /// <returns></returns>
        [ApiBind(PlatformType.WeChat_Open, "QRConnectAPI.AuthAsync", true)]
        public static async Task<OpenJsonResult> AuthAsync(string accessToken, string openId)
        {
            var url = string.Format(WxConfig.ApiMpHost + "/sns/auth?access_token={0}&openid={1}", accessToken.AsUrlData(), openId.AsUrlData());
            return await CommonJsonSend.SendAsync<OpenJsonResult>(null, url, null, CommonJsonSendType.GET);
        }
        #endregion
#endif
    }
