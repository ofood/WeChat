...
namespace OFoodWeChat.Open.Entities
{
    ...
    /// </summary>
    [Serializable]
    public class OpenJsonResult : BaseJsonResult
    {
        ...
        {
            return string.Format("OpenJsonResult：{{errcode:'{0}',errcode_name:'{1}',errmsg:'{2}'}}",
