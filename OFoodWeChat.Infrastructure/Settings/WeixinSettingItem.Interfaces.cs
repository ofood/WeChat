...
namespace OFoodWeChat.Infrastructure.Settings
{
    ...
    /// 公众号
    /// </summary>
    public interface IWeixinSettingForMP : IWeixinSettingBase
    {
        /// <summary>
        /// 公众号Token
        /// </summary>
    ...
    /// 小程序
    /// </summary>
    public interface IWeixinSettingForWxOpen : IWeixinSettingBase
    {
        /// <summary>
        /// 小程序AppId
        /// </summary>
    ...
    /// 企业号
    /// </summary>
    public interface IWeixinSettingForWork : IWeixinSettingBase
    {
        /// <summary>
        /// 企业微信CorpId
        /// </summary>
    ...
    /// 微信支付（旧版）
    /// </summary>
    public interface IWeixinSettingForOldTenpay : IWeixinSettingBase
    {
        /// <summary>
    ...
    /// 微信支付V3
    /// </summary>
    public interface IWeixinSettingForTenpayV3 : IWeixinSettingBase
    {
        /// <summary>
        /// MchId（商户ID）
        /// </summary>
    ...
    /// 开放平台
    /// </summary>
    public interface IWeixinSettingForOpen : IWeixinSettingBase
    {
        /// <summary>
        /// Component_Appid
        /// </summary>
    ...
    /// 扩展
    /// </summary>
    public interface IWeixinSettingForExtension : IWeixinSettingBase
    {
